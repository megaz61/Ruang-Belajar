    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body"style="box-shadow: rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px;">
                        <h4 class="card-title mb-4">Upload Materi</h4>
                        ...
                        <form class="forms-sample" action="{{ route('storeMateri', ['id' => Auth::user()->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <label for="exampleInputName1 mt-5">Nama/Judul Materi</label>
                        ...
                        <div class="form-check">
                          <label class="form-check-label">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="keterangan" id="exampleTextarea1" rows="4"></textarea>
                            </div>
